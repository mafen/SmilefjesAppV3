...
public class KravViewModel extends ViewModel {
    ...
    public TilsynRepository kravRepository;
    public MutableLiveData<Kravpunkt> krav = new MutableLiveData<>() ;
        ...
        kravRepository.lesKrav(id, new Callback<AlleKrav>() {
            ...
            public void onResponse(Call<AlleKrav> call, @NotNull Response<AlleKrav> response) {
                ...
                if(response.isSuccessful()){
                    List<Kravpunkt> body = response.body().getKravList();
                    Log.d("Krav", ""+ body.get(1).getKarakter());
            ...
            public void onFailure(Call<AlleKrav> call, Throwable t) {
                kravListe.setValue(new ArrayList<Kravpunkt>(Collections.singleton(new Kravpunkt("Ingen data funnet"))));
